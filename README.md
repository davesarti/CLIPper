...
- `src/` — data loading, prompts + `compose()`/`rank()`, metrics, CLIP wrapper with feature cache
- `scripts/` — `smoke_test.py` (quick check), `run_baseline.py` (full run, ~45 min CPU once, then cached)
